...
<head>
    ...
    <title>Sign In | House Rental Management System</title>
        ...
        <section class="auth-card" aria-labelledby="login-title">
            ...
            <form class="register-form" id="loginForm" method="post" novalidate>
                ...
                <div class="field">
                    ...
                    <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($email, ENT_QUOTES, 'UTF-8'); ?>" placeholder="you@example.com" autocomplete="email" required>
                </div>
                ...
                <p style="margin-top: 1.5rem; text-align: center; font-size: 0.9rem; color: var(--muted);">
                    Don't have an account? <a href="index.php" style="color: var(--accent); text-decoration: none; font-weight: 600;">Register here</a>.
                </p>
            </form>
        </section>
    </main>
